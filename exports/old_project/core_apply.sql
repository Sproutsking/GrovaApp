...
-- Minimal profiles table required by core foreign keys
...
-- Minimal ambassador_profiles table required by core foreign keys
...
-- Minimal payments table required by core foreign keys
...
-- Minimal live_sessions table required by core foreign keys
...
CREATE TABLE IF NOT EXISTS public.ambassador_referrals (
  ...
  PRIMARY KEY (id),
  FOREIGN KEY (ambassador_id) REFERENCES public.ambassador_profiles(id),
...
CREATE TABLE IF NOT EXISTS public.ambassador_earnings (
  ...
  PRIMARY KEY (id),
  FOREIGN KEY (ambassador_id) REFERENCES public.ambassador_profiles(id),
  FOREIGN KEY (ref_referral_id) REFERENCES public.ambassador_referrals(id)
);
...
CREATE TABLE IF NOT EXISTS public.culture_content (
  ...
  created_at timestamptz DEFAULT now(),
  PRIMARY KEY (id),
  FOREIGN KEY (category_id) REFERENCES public.culture_categories(id),
  FOREIGN KEY (user_id) REFERENCES public.profiles(id),
  FOREIGN KEY (featured_by) REFERENCES public.profiles(id)
);
...
CREATE TABLE IF NOT EXISTS public.culture_creator_profiles (
  ...
  PRIMARY KEY (id),
  FOREIGN KEY (user_id) REFERENCES public.profiles(id),
  FOREIGN KEY (primary_category_id) REFERENCES public.culture_categories(id)
);
...
CREATE TABLE IF NOT EXISTS public.culture_popular_this_week (
  id uuid,
  content_type text,
  content_id uuid,
  category_name text,
...
CREATE TABLE IF NOT EXISTS public.news_bookmarks (
  ...
  PRIMARY KEY (id),
  FOREIGN KEY (user_id) REFERENCES public.profiles(id),
  FOREIGN KEY (news_id) REFERENCES public.news_posts(id)
);
...
CREATE TABLE IF NOT EXISTS public.news_comments (
  ...
  FOREIGN KEY (news_id) REFERENCES public.news_posts(id),
  FOREIGN KEY (user_id) REFERENCES public.profiles(id),
  FOREIGN KEY (parent_id) REFERENCES public.news_comments(id)
);
...
CREATE TABLE IF NOT EXISTS public.platform_distribution_preferences (
  id uuid DEFAULT gen_random_uuid() NOT NULL,
  user_id uuid,
...
CREATE TABLE IF NOT EXISTS public.reels_backup (
  id uuid,
  user_id uuid,
  video_url text,
  video_id text,
...
CREATE TABLE IF NOT EXISTS public.reward_level_history (
  id uuid DEFAULT gen_random_uuid() NOT NULL,
  user_id uuid NOT NULL,
...
-- Generated from schema_definitions.json for shares
CREATE TABLE IF NOT EXISTS public.shares (
  id uuid DEFAULT gen_random_uuid() NOT NULL,
  content_type text NOT NULL,
  content_id uuid NOT NULL,
  user_id uuid NOT NULL,
  share_type text DEFAULT 'profile',
  created_at timestamptz DEFAULT now(),
  PRIMARY KEY (id),
  FOREIGN KEY (user_id) REFERENCES public.profiles(id)
);
...
CREATE TABLE IF NOT EXISTS public.stories_backup (
  id uuid,
  user_id uuid,
  title text,
  preview text,
...
CREATE TABLE IF NOT EXISTS public.stream_tier_limits (
  tier text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.stream_usage_logs (
  id uuid DEFAULT gen_random_uuid() NOT NULL,
  user_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.support_cases (
  ...
  FOREIGN KEY (solved_by_id) REFERENCES public.profiles(id),
  FOREIGN KEY (escalated_to_id) REFERENCES public.profiles(id)
);

-- Generated from schema_definitions.json for unlocked_stories
CREATE TABLE IF NOT EXISTS public.unlocked_stories (
  id uuid DEFAULT gen_random_uuid() NOT NULL,
  story_id uuid NOT NULL,
  user_id uuid NOT NULL,
  created_at timestamptz DEFAULT now(),
...
CREATE TABLE IF NOT EXISTS public.user_culture_alignment (
  user_id uuid,
  category_id uuid,
  name text,
...
CREATE TABLE IF NOT EXISTS public.xrc_root_chain (
  stream_type text NOT NULL,
  ...
  FOREIGN KEY (last_record_id) REFERENCES public.xrc_records(record_id)
);

-- Generated from schema_definitions.json for xrc_stream_heads
CREATE TABLE IF NOT EXISTS public.xrc_stream_heads (
  stream_type text,
