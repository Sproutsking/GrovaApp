...
CREATE TABLE IF NOT EXISTS public.ambassador_profiles (
  ...
  CONSTRAINT ambassador_profiles_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.profiles(id),
  CONSTRAINT ambassador_profiles_approved_by_fkey FOREIGN KEY (approved_by) REFERENCES public.profiles(id)
);
