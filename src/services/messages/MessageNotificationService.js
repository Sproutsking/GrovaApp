// ============================================================================
// src/services/messages/MessageNotificationService.js — v8 FULLY WIRED
// ============================================================================
// FIXES vs v7:
...
//  [M7]  triggerCallPush() now delegates to pushService.sendPushToUser()
//        instead of calling supabase.functions.invoke() directly. The direct
//        invoke was bypassing pushService and double-nesting the data field,
//        producing { data: { data: { type } } } instead of { data: { type } }.
//        The SW saw type=undefined and never showed call notifications.
// ============================================================================
...
class MessageNotificationService {
  ...
  async init(userId, toastCallback) {
    ...
    console.log("[MsgNotif] v8 init:", userId);
  }
  ...
  // [M7] FIXED: delegates to pushService.sendPushToUser() instead of
  // calling supabase.functions.invoke() directly.
  // The old direct invoke sent { data: { type, call_id } } at the top level
  // AND inside metadata, causing the edge fn to double-nest it into
  // payload.data.data.type — the SW always saw type=undefined.
  async triggerCallPush({
    ...
    try {
      ...
      console.warn("[MsgNotif] call push:", e?.message || e);
    }
  }
