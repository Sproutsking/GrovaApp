...
const EmailVerificationModal = ({ show, onClose, userId, currentEmail, onSuccess }) => {
  ...
  const sendVerificationCode = async () => {
    try {
      ...
      // In production, send email via SendGrid/similar
        ...
        <div style={{
          ...
          <div style={{
            ...
            <h2 style={{ fontSize: '20px', fontWeight: '700', color: '#fff', margin: 0, display: 'flex', alignItems: 'center', gap: '8px' }}>
              <Mail size={20} style={{ color: '#84cc16' }} />
            ...
            {step === 1 ? (
              <>
                <div style={{
                  ...
                  <p style={{ color: '#a3a3a3', fontSize: '13px', margin: 0 }}>
                    Current email: <strong style={{ color: '#84cc16' }}>{currentEmail}</strong>
                  </p>
                </div>
                ...
                <button
                  ...
                  style={{
                    width: '100%',
                    padding: '14px',
                    background: loading || !newEmail ? '#333' : 'linear-gradient(135deg, #84cc16 0%, #65a30d 100%)',
                    border: 'none',
                    borderRadius: '12px',
                    color: loading || !newEmail ? '#666' : '#000',
                    fontSize: '16px',
                    fontWeight: '700',
                    cursor: loading || !newEmail ? 'not-allowed' : 'pointer',
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center',
                    gap: '8px'
              ...
              <>
                <p style={{ color: '#a3a3a3', marginBottom: '24px', fontSize: '14px', lineHeight: '1.5' }}>
                  ...
                  <strong style={{ color: '#84cc16' }}>{newEmail}</strong>
                </p>
