...
const TRINITY_TABS = {
  ...
  student: [
    { id: "feed",      Icon: PostsIcon, label: "Study Feed" },
    { id: "lessons",   Icon: StoriesIcon, label: "Lessons" },
    { id: "resources", Icon: NewsIcon, label: "Resources" },
    { id: "study",     Icon: CultureIcon, label: "Study Hub" },
  ],
};
