// paywave/constants.js  ── v3 REFINED EDITION
// ─────────────────────────────────────────────────────────────
// Static config shared across PayWave.
// NO backend changes. All field names, table names, and IDs
// are identical to the original. Only the COLOR object is
// updated to match the new design system tokens.
// ─────────────────────────────────────────────────────────────
...
export const COLOR = {
  ...
  lime:         "#a3e635",
  limeDim:      "#84cc16",
  limeGlow:     "rgba(163,230,53,0.12)",
  limeBorder:   "rgba(163,230,53,0.22)",
  gold:         "#d4a847",
  goldDim:      "rgba(212,168,71,0.1)",
  goldBorder:   "rgba(212,168,71,0.24)",
  text:         "#eef2ec",
  textSoft:     "rgba(255,255,255,0.5)",
  textMuted:    "rgba(255,255,255,0.28)",
};

// ── App data — all IDs and field names unchanged ─────────────
...
// NOTE: TRANSACTIONS array intentionally absent.
// All transaction data is fetched live from Supabase
// via wallet_history and paywave_transfers tables.