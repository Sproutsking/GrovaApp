    ...
    <div className="wallet-app">
      <div className="wallet-container">
        ...
        <div className="wallet-content">
          ...
          {activeTab === 'deposit' && <DepositTab setActiveTab={setActiveTab} />}
          {activeTab === 'receive' && <ReceiveTab setActiveTab={setActiveTab} />}
          {activeTab === 'swap' && <SwapTab setActiveTab={setActiveTab} />}
          {activeTab === 'trade' && <TradeTab setActiveTab={setActiveTab} />}
          {activeTab === 'settings' && <SettingsTab setActiveTab={setActiveTab} />}
        </div>
      </div>
    </div>
  );
