...
const SendTab = ({
  ...
  const handleSend = useCallback(async () => {
    ...
    const optTx = {
      ...
      change_type: "debit",
      amount: parsed,
      metadata: { currency, ep_burn: epBurn, note },
      ...
      counterparty: selectedUser ? {
        ...
        avatar_metadata: selectedUser.avatar_metadata,
      } : null,
      note,
    };
      ...
      <div className="view-enter" style={{ display:"flex",flexDirection:"column",alignItems:"center",padding:"60px 20px" }}>
        ...
        {selectedUser ? (
          <div onClick={() => setProfileUser(selectedUser)} style={{
            ...
            padding:"9px 14px",borderRadius:100,background:"rgba(255,255,255,.04)",
            border:"1px solid rgba(255,255,255,.08)",
          }}>
            <XevAvatar profile={selectedUser} size={38} />
            <div>
              ...
              <div style={{ fontSize:11,color:"#a3e635",fontFamily:"DM Mono,monospace" }}>@{selectedUser.username}</div>
            </div>
        ...
        {rpcDone && txId && (
          <div style={{ display:"inline-flex",alignItems:"center",gap:6,padding:"4px 10px",background:"rgba(163,230,53,.06)",border:"1px solid rgba(163,230,53,.15)",borderRadius:100,fontSize:11,color:"#a3e635",marginBottom:20 }}>
      ...
      <div className="view-enter">
        ...
        {selectedUser && (
          <div onClick={() => setProfileUser(selectedUser)} style={{
            ...
            background:"rgba(163,230,53,.04)",border:"1px solid rgba(163,230,53,.15)",
            borderRadius:16,cursor:"pointer",transition:"background .15s",
          }}>
            <XevAvatar profile={selectedUser} size={46} />
            <div style={{ flex:1 }}>
        ...
        <div className="field-group">
          ...
          {selectedUser ? (
            <div className="rcpt-card">
              <XevAvatar profile={selectedUser} size={42} />
