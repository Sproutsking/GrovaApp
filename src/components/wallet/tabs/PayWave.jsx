// src/components/wallet/tabs/PayWave.jsx
      ...
      <>
          ...
          <div className="form-card">
            <div className="form-group">
              ...
              <input
                ...
                value={pinForm.old}
                onChange={(e) =>
                  setPinForm({ ...pinForm, old: e.target.value })
                }
              />
            </div>
            <div className="form-group">
        ...
        {subView === "enableBiometrics" && (
          <div className="form-card">
            ...
            <button className="btn-primary" onClick={() => setSubView(null)}>
              Save
            </button>
          </div>
        )}
  ...
  return (
    <>
      <div className="view-header">
        ...
        <div>
          <h2 className="view-title">Pay Wave</h2>
      ...
      <div className="settings-section">
        ...
        <button
          className="settings-item"
          onClick={() => setSubView("enableBiometrics")}
        >
          <Shield size={20} />
          <div className="settings-item-info">
            <span>Enable Biometrics</span>
      ...
      <div className="settings-section">
        ...
        <button
          className="settings-item"
          onClick={() => setSubView("transactionAlerts")}
        >
          <Bell size={20} />
          <div className="settings-item-info">
            <span>Transaction Alerts</span>
      ...
      <div className="settings-section">
        ...
        <button
          className="settings-item"
          onClick={() => setSubView("recoveryPhrase")}
        >
          <Key size={20} />
          <div className="settings-item-info">
