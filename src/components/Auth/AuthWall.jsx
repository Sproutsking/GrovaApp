...
const TextProviderI = ({ label, color }) => (
  <span style={{ color, fontSize: 12, fontWeight: 900, letterSpacing: "-.04em" }} aria-hidden>{label}</span>
);
...
function LoginView() {
  ...
  const PROVIDER_CATALOG = {
    ...
    roblox: {
      id: "roblox",
      icon: <TextProviderI label="R" color="#fff" />,
    ...
    fortnite: {
      id: "fortnite",
      icon: <TextProviderI label="FN" color="#fff" />,
      label: "Continue with Fortnite",
      g1: "#2dd4bf",
      g2: "#60a5fa",
      g3: "#2563eb",
    },
    minecraft: {
      id: "minecraft",
      icon: <TextProviderI label="M" color="#fff" />,
      label: "Continue with Minecraft",
      g1: "#65a30d",
      g2: "#a3e635",
      g3: "#365314",
    },
    dynamic: {
      id: "dynamic",
      icon: <TextProviderI label="D" color="#fff" />,
    ...
    privy: {
      id: "privy",
      icon: <TextProviderI label="P" color="#fff" />,
    ...
    web3auth: {
      id: "web3auth",
      icon: <TextProviderI label="W3" color="#fff" />,
      label: "Continue with Web3Auth",
      g1: "#0ea5e9",
      g2: "#67e8f9",
      g3: "#0369a1",
    },
    rainbowkit: {
      id: "rainbowkit",
      icon: <TextProviderI label="RK" color="#fff" />,
      label: "Continue with RainbowKit",
      g1: "#ec4899",
      g2: "#f9a8d4",
      g3: "#be185d",
    },
