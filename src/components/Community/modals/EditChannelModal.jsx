  ...
  return ReactDOM.createPortal(
    <>
        ...
        <div className="channel-modal" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="modal-body channel-modal-body">
            ...
            <div className="form-group">
              ...
              <input type="text" className="form-input" value={formData.category} onChange={(e) => setFormData({ ...formData, category: e.target.value })} placeholder="Channel category" maxLength={50} />
            </div>
      ...
      <style>{`
        ...
        .channel-modal-header{position:sticky;top:0;z-index:3;display:flex;align-items:center;justify-content:space-between;padding:16px 20px;background:#101711;backdrop-filter:none;border-bottom:1px solid rgba(156,255,0,.18);}
