...
export default function SocialUpdatesDashboard({ communityId, userId, channels = [], linkedSources = [], canManage = false }) {
  ...
  return (
    <div className="social-dashboard-body">
      ...
      <div className="social-dashboard-capabilities"><span><Check size={13} /> Ready inbound: Xeevia, X, Facebook, Instagram, YouTube, Twitch, LinkedIn, GitHub, Reddit</span><span><Wifi size={13} /> Live detection: YouTube, Twitch, Facebook, Instagram</span></div>
