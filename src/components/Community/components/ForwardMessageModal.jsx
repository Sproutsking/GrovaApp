...
const ForwardMessageModal = ({ message, userId, onClose, onOpenDm }) => {
  ...
  return (
    <div className="forward-overlay" onClick={onClose}>
      ...
      <style>{`
        .forward-overlay{position:fixed;inset:0;z-index:100001;display:flex;align-items:center;justify-content:center;padding:16px;background:rgba(0,0,0,.42);backdrop-filter:blur(3px)}
