      ...
      <section className="community-profile-card" onClick={(event) => event.stopPropagation()}>
        ...
        <div className="community-profile-body">
          ...
          <div className="community-profile-membership">
            <div><span className="membership-icon xeevia">✦</span><span><small>Xeevia member since</small><strong>{formatMemberDate(user?.created_at || user?.createdAt)}</strong></span></div>
