...
begin
  ...
  if boost_row.boost_tier = 'silver' then
    ...
    allowed_colors := array['diamond-prism', 'diamond-cosmos', 'diamond-glacier', 'diamond-emerald', 'diamond-rose', 'diamond-inferno', 'diamond-aurora', 'diamond-lime', 'diamond-void', 'diamond-royal'];
  else
